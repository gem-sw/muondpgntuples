...
/** \class MuNtupleDTTPGThetaFiller MuNtupleDTTPGThetaFiller.h MuDPGAnalysis/MuonDPGNtuples/src/MuNtupleDTTPGThetaFiller.h
 *  
...
class MuNtupleDTTPGThetaFiller : public MuNtupleBaseFiller
{
 ...
 public:
  ...
  /// Constructor
  MuNtupleDTTPGThetaFiller(edm::ConsumesCollector && collector,
			     const std::shared_ptr<MuNtupleConfig> config, 
			     std::shared_ptr<TTree> tree, const std::string & label, 
			     TriggerTag tag);

  ///Destructor
  virtual ~MuNtupleDTTPGThetaFiller();
