/** \class MuNtupleBmtfFiller MuNtupleBmtfFiller.cc MuDPGAnalysis/MuonDPGNtuples/src/MuNtupleBmtfFiller.cc
 *  
...
MuNtupleBmtfFiller::~MuNtupleBmtfFiller() 
{ 

};

void MuNtupleBmtfFiller::initialize()
{
...
void MuNtupleBmtfFiller::fill(const edm::Event & ev)
{
