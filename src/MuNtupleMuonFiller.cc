/** \class MuNtupleMuonFiller MuNtupleMuonFiller.cc MuDPGAnalysis/MuonDPGNtuples/src/MuNtupleMuonFiller.cc
 *  
...
MuNtupleMuonFiller::MuNtupleMuonFiller(edm::ConsumesCollector && collector,
...
MuNtupleMuonFiller::~MuNtupleMuonFiller() 
{ 

}

void MuNtupleMuonFiller::initialize()
{
...
void MuNtupleMuonFiller::fill(const edm::Event & ev)
{
      ...
      for (const auto & muon : (*muons))
	{
	  ...
	  if(!muon.innerTrack().isNull())
	  ...
	  else
	    {
	       ...
	       m_trk_dxy.push_back(MuNtupleBaseFiller::DEFAULT_DOUBLE_VAL);
	       m_trk_dz.push_back(MuNtupleBaseFiller::DEFAULT_DOUBLE_VAL);
	       m_trk_algo.push_back(MuNtupleBaseFiller::DEFAULT_INT_VAL_POS);
	       m_trk_origAlgo.push_back(MuNtupleBaseFiller::DEFAULT_INT_VAL_POS);
	       m_trk_numberOfValidPixelHits.push_back(MuNtupleBaseFiller::DEFAULT_INT_VAL_POS);
	       m_trk_numberOfValidTrackerLayers.push_back(MuNtupleBaseFiller::DEFAULT_INT_VAL_POS);
	  ...
	  if(muon.isStandAloneMuon())
	  ...
	  else
	    {
	      ...
	      m_staMu_numberOfValidMuonHits.push_back(MuNtupleBaseFiller::DEFAULT_INT_VAL_POS);
	      m_staMu_normChi2.push_back(MuNtupleBaseFiller::DEFAULT_DOUBLE_VAL_POS);
	  ...
	  if(muon.isGlobalMuon())
	  ...
	  else
	    {
	      ...
	      m_glbMu_normChi2.push_back(MuNtupleBaseFiller::DEFAULT_DOUBLE_VAL_POS);
...
float MuNtupleMuonFiller::computeTrkIso(const reco::MuonIsolation & isolation, float muonPt)
{
...
float MuNtupleMuonFiller::computePFIso(const reco::MuonPFIsolation & pfIsolation, float muonPt)
{
...
bool MuNtupleMuonFiller::hasTrigger(std::vector<int> & trigIndices, 
