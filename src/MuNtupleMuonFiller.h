#ifndef MuNtuple_MuNtupleMuonFiller_h
#define MuNtuple_MuNtupleMuonFiller_h

/** \class MuNtupleMuonFiller MuNtupleMuonFiller.h MuDPGAnalysis/MuonDPGNtuples/src/MuNtupleMuonFiller.h
 *  
...
class MuNtupleMuonFiller : public MuNtupleBaseFiller
{

 public:

  /// Constructor
  MuNtupleMuonFiller(edm::ConsumesCollector && collector,
		     const std::shared_ptr<MuNtupleConfig> config, 
		     std::shared_ptr<TTree> tree, const std::string & label);
  
  ///Destructor
  virtual ~MuNtupleMuonFiller();
