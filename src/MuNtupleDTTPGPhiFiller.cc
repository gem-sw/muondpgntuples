/** \class MuNtupleDTTPGPhiFiller MuNtupleDTTPGPhiFiller.cc MuDPGAnalysis/MuonDPGNtuples/src/MuNtupleDTTPGPhiFiller.cc
 *  
...
MuNtupleDTTPGPhiFiller::~MuNtupleDTTPGPhiFiller() 
{ 

};

void MuNtupleDTTPGPhiFiller::initialize()
{
...
void MuNtupleDTTPGPhiFiller::clear()
{
...
void MuNtupleDTTPGPhiFiller::fill(const edm::Event & ev)
{
