/** \class MuNtupleDTTPGThetaFiller MuNtupleDTTPGThetaFiller.cc MuDPGAnalysis/MuonDPGNtuples/src/MuNtupleDTTPGThetaFiller.cc
 *  
...
MuNtupleDTTPGThetaFiller::~MuNtupleDTTPGThetaFiller() 
{ 

};

void MuNtupleDTTPGThetaFiller::initialize()
{
...
void MuNtupleDTTPGThetaFiller::clear()
{
...
void MuNtupleDTTPGThetaFiller::fill(const edm::Event & ev)
{
