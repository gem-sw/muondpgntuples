...
/** \class MuNtupleDTTPGPhiFiller MuNtupleDTTPGPhiFiller.h MuDPGAnalysis/MuonDPGNtuples/src/MuNtupleDTTPGPhiFiller.h
 *  
...
class MuNtupleDTTPGPhiFiller : public MuNtupleBaseFiller
{
 ...
 public:
  ...
  /// Constructor
  MuNtupleDTTPGPhiFiller(edm::ConsumesCollector && collector,
			     const std::shared_ptr<MuNtupleConfig> config, 
			     std::shared_ptr<TTree> tree, const std::string & label, 
			     TriggerTag tag);

  ///Destructor
  virtual ~MuNtupleDTTPGPhiFiller();
