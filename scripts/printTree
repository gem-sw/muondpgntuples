#!/usr/bin/env python
"""
This program can be used to print the size of each of 
the tree branches and fillers of the muon DPG tree.
"""
...
PARSER.add_argument("-d", "--directory",
                    default="muNtupleProducer",
                    help="Directory in the input ROOT file which \
                          contains the muon DPG ntuple")
